...
export default forwardRef<HTMLFormElement, Props>(({ title, children, ...props }, ref) => (
    <div className="w-full max-w-md mx-auto">
        <div className="relative">
            ...
            <div className="relative bg-white/[0.04] backdrop-blur-xl rounded-2xl p-8 border border-white/10 shadow-2xl shadow-blue-500/10">
                ...
                <Form {...props} ref={ref} className="relative">
                    {children}
                </Form>
            </div>
        </div>
