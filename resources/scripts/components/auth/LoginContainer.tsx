    ...
    return (
        <div className="min-h-screen min-h-[100dvh] w-full flex items-center justify-center bg-[#030712] relative overflow-x-hidden overflow-y-auto">
            ...
            <div className="fixed inset-0 w-full h-full">
                ...
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(37,99,235,0.05)_0%,transparent_50%)]"></div>
            ...
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-8 sm:py-12">
                <div className="grid lg:grid-cols-2 gap-8 items-center min-h-[calc(100dvh-4rem)]">
                    {/* Left Hero Section */}
                    ...
                    {/* Right Login Card */}
                    <div className="flex justify-center items-center w-full animate-fadeInRight">
                                ...
                                {({ isSubmitting, setSubmitting, submitForm, values, handleChange, errors, touched }) => (
                                    <LoginFormContainer>
                                        ...
                                        <div className="relative mb-5 group">
                                            <div className="absolute left-4 top-1/2 -translate-y-1/2 text-blue-400 group-focus-within:text-blue-300 transition-colors duration-300 z-10">
                                            ...
                                            <input
                                                ...
                                                className={`w-full pl-12 pr-4 py-4 bg-white/5 border rounded-xl text-white placeholder-blue-300/40 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 ${
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0 mb-6">
                                            ...
                                            <Link 
                                                to={'/auth/password'}
                                                className="text-sm text-blue-400 hover:text-blue-300 transition-colors duration-200 hover:underline text-left sm:text-right"
                                            >
                                                Forgot Password?
                                            </Link>
                                        </div>
