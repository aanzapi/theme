...
const LoginContainer = ({ history }: RouteComponentProps) => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#030712] via-[#0A1628] to-[#111827] relative overflow-hidden">
            {/* Animated Background */}
            <div className="absolute inset-0">
                ...
                <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg"%3E%3Cfilter id="noiseFilter"%3E%3CfeTurbulence type="fractalNoise" baseFrequency="0.9" numOctaves="4" stitchTiles="stitch"/%3E%3C/filter%3E%3Crect width="100%25" height="100%25" filter="url(%23noiseFilter)" opacity="0.04"/%3E%3C/svg%3E')]"></div>
                                ...
                                <LoginFormContainer>
                                    ...
                                    <div className="mt-8 text-center space-y-2">
                                        <p className="text-xs text-blue-200/40">
                                            © 2015 - {new Date().getFullYear()} Azx Panel
                                        </p>
