...
const LoginContainer = ({ history }: RouteComponentProps) => {
    ...
    return (
        <div className="min-h-screen min-h-[100dvh] w-full flex items-center justify-center bg-gradient-to-br from-gray-900 via-blue-950 to-gray-900 relative overflow-x-hidden overflow-y-auto">
                                        ...
                                        <div className="flex justify-center mb-6">
                                            <div className="relative">
                                                ...
                                                <img 
                                                    ...
                                                    alt="Logo" 
                                                    className="w-16 sm:w-20 h-16 sm:h-20 relative"
                                                />
                                            </div>
                                        </div>
